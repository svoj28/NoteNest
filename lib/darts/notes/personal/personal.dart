...
import 'package:memo_vault/darts/notes/personal/read/personalnote_details_screen.dart';
import 'package:memo_vault/darts/notes/personal/add/personalnote_add_screen.dart';
...
class _PersonalScreenState extends State<PersonalScreen> {
  ...
  void _loadNotes() {
    setState(() {
      _notes = DatabaseHelper().getpersonalNotes();
    });
  }
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                await DatabaseHelper()
                    .updatePersonalNotePinned(noteId, !isPinned);
  ...
  Future<void> _showDeleteConfirmation(int noteId) async {
    ...
    if (confirmed == true) {
      await DatabaseHelper().deletepersonalNoteById(noteId);
      _filterNotes(); // Refresh the list
    }
  }

...
import 'package:memo_vault/darts/notes/lecture/read/lecturenote_details_screen.dart';
import 'package:memo_vault/darts/notes/lecture/add/lecturenote_add_screen.dart';
...
class _LectureScreenState extends State<LectureScreen> {
  ...
  void _loadNotes() {
    setState(() {
      _notes = DatabaseHelper().getlectureNotes();
    });
  }
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                await DatabaseHelper()
                    .updateLectureNotePinned(noteId, !isPinned);
  ...
  Future<void> _showDeleteConfirmation(int noteId) async {
    ...
    if (confirmed == true) {
      await DatabaseHelper().deletelectureNoteById(noteId);
      _filterNotes(); // Refresh the list
    }
  }
